...
class PortfolioList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio List', 'foton-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Portfolio List Template', 'foton-core' ),
							'value'       => array(
								esc_html__( 'Gallery', 'foton-core' ) => 'gallery',
								esc_html__( 'Masonry', 'foton-core' ) => 'masonry'
							),
							'save_always' => true,
							'admin_label' => true
						),
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Per Page', 'foton-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Fixed Image Proportions', 'foton-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Rounded Images', 'foton-core' ),
							'value'       => array_flip( foton_mikado_get_yes_no_select_array( false ) ),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Gallery - Overlay Additional', 'foton-core' )      => 'gallery-overlay-additional',
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Type', 'foton-core' ),
							'value'      => array(
								esc_html__( 'None', 'foton-core' )            => 'no-pagination',
								esc_html__( 'Standard', 'foton-core' )        => 'standard',
								esc_html__( 'Load More', 'foton-core' )       => 'load-more',
								esc_html__( 'Infinite Scroll', 'foton-core' ) => 'infinite-scroll'
							),
							'group'      => esc_html__( 'Additional Features', 'foton-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'load_more_top_margin',
							'heading'    => esc_html__( 'Load More Top Margin (px or %)', 'foton-core' ),
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'filter',
							'heading'    => esc_html__( 'Enable Category Filter', 'foton-core' ),
							'value'      => array_flip( foton_mikado_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Additional Features', 'foton-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Order By', 'foton-core' ),
							'value'      => array(
								esc_html__( 'Name', 'foton-core' )  => 'name',
								esc_html__( 'Count', 'foton-core' ) => 'count',
								esc_html__( 'Id', 'foton-core' )    => 'id',
								esc_html__( 'Slug', 'foton-core' )  => 'slug'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Filter Text Transform', 'foton-core' ),
							'value'      => array_flip( foton_mikado_get_text_transform_array( true ) ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'foton-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Bottom Margin (px or %)', 'foton-core' ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'foton-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Article Animation', 'foton-core' ),
							'value'       => array_flip( foton_mikado_get_yes_no_select_array( false ) ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = foton_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
