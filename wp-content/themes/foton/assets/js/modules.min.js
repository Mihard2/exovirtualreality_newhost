...
function (T) {
    ...
    function n() {
        z(), p().init(), g(), T(window).on("elementor/frontend/init", function () {
    ...
    }, e.mkdfOwlSlider = v, e.mkdfInitParallax = z, e.mkdfInitSelfHostedVideoPlayer = m, e.mkdfSelfHostedVideoSize = l, e.mkdfPrettyPhoto = c, e.mkdfStickySidebarWidget = p, e.getLoadMoreData = function (e) {
        var t = e.data(),
            n = {};
    ...
    }, e.mkdfInitParallaxElements = g, e.mkdfOnDocumentReady = t, e.mkdfOnWindowLoad = n, e.mkdfOnWindowResize = a, T(document).ready(t), T(window).load(n), T(window).resize(a);
    var s = function () {
        function i(t) {
    ...
    function v() {
        ...
        e.length && e.each(function () {
            ...
            var _ = 2,
                ...
                I = o,
                S = o;
            if (o < 3 && (A = _ = o), 4 < o && (I = 4), 5 < o && (S = 5), (k || 30 < l) && (f = 20, c = 30), 0 < l && l <= 30 && (c = f = l), t.waitForImages(function () {
                    e = t.owlCarousel({
                        items: o,
                        loop: d,
                        autoplay: i,
                        ...
                        onInitialize: function () {
                            t.css("visibility", "visible"), z(), b && n.find(".mkdf-slider-thumbnail-item:first-child").addClass("active")
                        },
...
function (m) {
    ...
    function t() {
        m(document).on("click", ".mkdf-quantity-minus, .mkdf-quantity-plus", function (e) {
                e.stopPropagation();
                var t, n = m(this),
                    a = n.siblings(".mkdf-quantity-input"),
                    o = parseFloat(a.data("step")),
                    d = parseFloat(a.data("max")),
                    i = parseFloat(a.data("min")),
                    s = !1,
                    r = parseFloat(a.val());
                n.hasClass("mkdf-quantity-minus") && (s = !0), s ? i <= (t = r - o) ? a.val(t) : a.val(i) : (t = r + o, void 0 === d ? a.val(t) : d <= t ? a.val(d) : a.val(t)), a.trigger("change")
            }),
            function () {
                var e = m(".woocommerce-ordering .orderby");
                e.length && e.select2({
                    minimumResultsForSearch: 1 / 0
                });
                var t = m(".mkdf-woocommerce-page .mkdf-content .variations td.value select");
                t.length && t.select2();
                var n = m("#calc_shipping_country");
                n.length && n.select2();
                var a = m(".cart-collaterals .shipping select#calc_shipping_state");
                a.length && a.select2()
            }(),
            function () {
                var e = m(".mkdf-woo-single-page.mkdf-woo-single-has-pretty-photo .images .woocommerce-product-gallery__image");
    ...
    }(mkdf.modules.woocommerce = e).mkdfOnDocumentReady = t, m(document).ready(t)
}(jQuery),
function (u) {
    "use strict";
    var e = {};
        ...
        e.length && e.each(function () {
            ...
            void 0 !== l.data("custom-map-style") && (e = l.data("custom-map-style")), void 0 !== l.data("color-overlay") && !1 !== l.data("color-overlay") && (t = l.data("color-overlay")), void 0 !== l.data("saturation") && !1 !== l.data("saturation") && (n = l.data("saturation")), void 0 !== l.data("lightness") && !1 !== l.data("lightness") && (a = l.data("lightness")), void 0 !== l.data("zoom") && !1 !== l.data("zoom") && (o = l.data("zoom")), void 0 !== l.data("pin") && !1 !== l.data("pin") && (d = l.data("pin")), void 0 !== l.data("height") && !1 !== l.data("height") && (i = l.data("height")), void 0 !== l.data("unique-id") && !1 !== l.data("unique-id") && (s = l.data("unique-id")), void 0 !== l.data("scroll-wheel") && (r = l.data("scroll-wheel")), void 0 !== l.data("addresses") && !1 !== l.data("addresses") && (m = l.data("addresses")),
                function (e, t, n, a, o, d, i, s, r, m, l, f, c, u) {
                    ...
                    for ((f = new google.maps.Map(document.getElementById(r), w)).mapTypes.set("mkdf-style", p), g = 0; g < u.length; ++g) y(u[g], l, f, c);
...
function (z) {
    ...
    function n() {
        var e = z(".mkdf-vertical-showcase");
        e.length && e.each(function () {
            var r, m, l, f, c, u = z(this),
                e = z(".mkdf-wrapper"),
                k = (u.find(".mkdf-vs-item"), u.find(".mkdf-vs-stripe")),
                h = u.find(".mkdf-vs-inner-frame"),
                p = u.find(".mkdf-vs-frame-info"),
                v = p.find(".mkdf-vs-frame-slide-text"),
                g = p.find(".mkdf-vs-frame-slide-number"),
                w = p.find(".mkdf-vs-frame-title-image"),
                y = p.find(".mkdf-vs-frame-title"),
                b = p.find(".mkdf-vs-frame-subtitle"),
                C = u.find(".swiper-container"),
                x = C.find(".swiper-slide"),
                _ = x.length,
                A = 1,
                I = !1,
                S = p.find(".mkdf-vs-frame-bg-text .mkdf-vs-frame-bg-text-content"),
                O = z(".mkdf-logo-wrapper"),
                T = new Swiper(C, {
                    loop: !1,
                    direction: "vertical",
                    slidesPerView: 1,
            ...
            if (mkdf.windowWidth < 1025) {
                var n = z(".mkdf-mobile-header-inner").css("height");
            ...
            O.addClass("mkdf-logo-wrapper-vertical-showcase mkdf-vs-frame-even"), u.waitForImages(function () {
                ...
                function d() {
                    S.length && S.find("span").each(function (e) {
                        var t = z(this);
                        setTimeout(function () {
                ...
                function s() {
                    v.text(m), g.text("0" + r), w.html(l), y.text(f), b.text(c)
                }
                x.each(function () {
                        z(this).attr("slide-index", A), z(this).data("slide-index", A);
                        var e = z(this).find(".mkdf-vs-item>img").attr("src"),
                            t = z(this).find(".mkdf-vs-item>img").attr("alt");
                        void 0 !== e && h.append('<div><img src="' + e + '" alt="' + t + '"></div>'), A++
                    }), h.find("div:first-child").addClass("active"), o(), s(), a(),
                    function () {
                        if (S.length) {
                            var e = S.text().split("");
                            S.empty(), e.forEach(function (e) {
                                S.append('<span class="mkdf-vs-frame-bg-text-char">' + e + "</span>")
                            }), setTimeout(function () {
                                S.css("opacity", 1)
                            }, 100)
                        }
                        ...
                        o(), a(), h.find("div").removeClass("prev-active"), h.find("div.active").removeClass("active").addClass("prev-active"), h.find("div:nth-child(" + r + ")").addClass("active"), r == _ ? (I = !0, u.addClass("mkdf-vs-last-slide"), O.addClass("mkdf-vs-last-slide"), i()) : (I = !1, u.removeClass("mkdf-vs-last-slide"), O.removeClass("mkdf-vs-last-slide")), I || (i(), p.addClass("mkdf-vs-frame-animate-out"), setTimeout(function () {
    ...
    }(mkdf.modules.verticalShowcase = e).mkdfInitVerticalShowcase = n, e.mkdfOnDocumentReady = t, z(document).ready(t), z(window).load(function () {
        z(window).on("elementor/frontend/init", function () {
